      ...
      >
        <div className="relative">
          <input
            ...
            className={cn(
              "w-full px-5 py-4 rounded-2xl border-2 bg-card text-foreground font-mono text-lg",
        ...
        {showResult && !isCorrect && (
          ...
          >
            Correct answer: <span className="font-mono text-primary font-bold">{question.correctAnswer}</span>
          </motion.p>
        )}
