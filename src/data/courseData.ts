export type QuestionType = 'mcq' | 'fill-blank' | 'fix-code' | 'output-prediction';
...
export const badges = [
  { id: "python-starter", name: "Python Starter", icon: "🌟", levelRequired: 1 },
  { id: "logic-thinker", name: "Logic Thinker", icon: "🧠", levelRequired: 3 },
  { id: "loop-master", name: "Loop Master", icon: "🔄", levelRequired: 4 },
  { id: "certified", name: "Certified Pythonista", icon: "🏆", levelRequired: 5 },
];
